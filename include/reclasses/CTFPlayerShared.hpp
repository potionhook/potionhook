...
public:
    ...
    inline static bool IsDominatingPlayer(CTFPlayerShared *self, int ent_idx)
    {
        ...
        static auto IsDominatingPlayer_fn = (IsDominatingPlayer_t) signature;
    ...
    inline static bool IsCritBoosted(CTFPlayerShared *self)
    {
        ...
        static auto IsCritBoosted_fn = (IsCritBoosted_t) signature;
    ...
    inline static float CalculateChargeCap(CTFPlayerShared *self)
    {
        ...
        static auto CalculateChargeCap_fn = CalculateChargeCap_t(signature);
