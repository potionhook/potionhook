...
C_MannVsMachineStats *C_MannVsMachineStats::G_MannVsMachineStats()
{
    ...
    static uintptr_t addr                                 = CSignature::GetClientSignature("55 A1 ? ? ? ? 89 E5 5D C3 8D B6 00 00 00 00 55 89 E5 53 83 EC ? 8B 5D "
                                                                                                                           "? C7 83");
...
int *C_MannVsMachineStats::AddLocalPlayerUpgrade(int id, int &a3)
{
    ...
    static uintptr_t addr                                   = CSignature::GetClientSignature("55 89 E5 57 56 53 83 EC ? 8B 5D ? 8B 75 ? 8B 7D ? 8B 43 ? 8B 53 ? 83 "
