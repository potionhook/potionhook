...
{
static settings::RVariable<rgba_t> color_closed{ "zk.style.task.color.text.closed", "d7d7d7ff" };
...
static settings::RVariable<rgba_t> color_hovered{ "zk.style.task.color.background.hover", "616161ff" };
