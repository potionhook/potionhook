...
static settings::RVariable<rgba_t> color_checked{ "zk.style.checkbox.color.checked", "ffa200ff" };
static settings::RVariable<rgba_t> color_hover{ "zk.style.checkbox.color.hover", "1f1f1fff" };
} // namespace zerokernel_checkbox
