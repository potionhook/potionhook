...
settings::RVariable<rgba_t> SliderStyle::handle_body{ "zk.style.input.slider.color.handle_body", "ffa200ff" };
settings::RVariable<rgba_t> SliderStyle::handle_border{ "zk.style.input.slider.color.handle_border", "000000ff" };
settings::RVariable<rgba_t> SliderStyle::bar_color{ "zk.style.input.slider.color.bar", "1f1f1fff" };
} // namespace zerokernel
